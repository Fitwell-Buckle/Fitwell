 ...
 * emails. The email field searches your Gmail inline as you type — pick a
 * match (or paste a known address) and hit Add. Used by the supplier list
 * manager and the supplier detail page.
 */
