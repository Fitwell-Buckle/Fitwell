...
export const FINISHES: Finish[] = [
  ...
  { id: "matte_titanium", label: "Bead Blasted Titanium", group: "matte", baseColor: [0.44, 0.45, 0.47], metallic: 0.9, roughness: 0.5, swatch: "#717377" },
  { id: "matte_steel", label: "Bead Blasted Steel", group: "matte", baseColor: [0.5, 0.51, 0.53], metallic: 0.9, roughness: 0.5, swatch: "#808287" },
];
