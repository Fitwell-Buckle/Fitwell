...
export function InvoiceActions({
  ...
  return (
    <Card className="mt-5 p-6">
      ...
      {/* Original payment link (deposit when a deposit applies, otherwise the
          full invoice). Once a balance link has been generated by fulfilment
          the deposit is necessarily paid, so we hide this row to avoid two
          payment links sitting on the page at once. */}
      {shopifyInvoiceUrl && !balanceInvoiceUrl && (
        <p className="mt-2 text-sm">
          {depositCents > 0 ? "Deposit payment link" : "Payment link"}:{" "}
          <a
