...
export default async function InvoicePrintPage({
  ...
  const [inv, billing, logoUrl] = await Promise.all([
    getInvoiceDetail(id),
    getBillingSettings(),
    getStoreLogoUrl(),
  ]);
  ...
  // Fitwell's business details (best-effort; from Shopify Business details).
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mt-6 rounded-lg border border-zinc-200 bg-white p-8 print:border-0 print:p-0">
