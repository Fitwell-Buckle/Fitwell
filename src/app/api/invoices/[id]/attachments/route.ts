...
import { addInvoiceAttachment } from "@/lib/invoicing/service";
...
// Attach a customer document (e.g. their PDF purchase order) to an invoice.
export async function POST(
  ...
  try {
    ...
    const attachment = await addInvoiceAttachment({
      invoiceId: id,
      blobUrl: blob.url,
      filename: file.name,
